...
/*   Updated: 2020/04/20 00:29:16 by awoimbee         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#ifdef __AVX2__
	static size_t _static_len(const uint8_t *start, const uint8_t *end)
	{
...
#else
	static size_t _static_len(const uint8_t *s, const uint8_t *src_end)
	{
		uint8_t *src;
...
{
	return _static_len(self, self + self_total_size);
}
